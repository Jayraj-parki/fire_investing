    ...
    <>
      ...
      <main className={style.page} >
        <nav className={`navbar navbar-expand-lg bg-info ${style.custom_gradient}`}>
          <di className='row col-12 pt-2 d-flex  justify-content-evenly flex-col text-center'>
        ...
        <div className={`header ${!isSticky ? style.headerOuter : style.headerFixedOuter} row col-12 py-4 mx-auto`}>
          <div className={style.headerInner + ` row col-12 col-sm-10 mx-auto d-flex   justify-content-between `}>
            <div className={style.websiteName + ` col-auto d-flex  `}>
              ...
              <h1 className="col-auto text-light px-sm-2 my-auto ">Fire Investing</h1>
            </div>
        ...
        <div className={style.banner + ` row col-12 pt-3 mx-auto d-flex justify-content-around `}>
          <div className={style.left + ` col-sm-10 col-xl-6 p-3  d-flex flex-column `}>
            <div className="mb-auto text-center text-sm-start">
              <h3 className="h2">Discover new trading horizons</h3>
              <h3 className="h2">with <span>NISM Certiifed</span> analysts</h3>
            </div>
            <div className="mb-auto text-center text-sm-start">
              <p className="h5 pt-4 text-center text-sm-start mb-4 mb-sm-0 ">Join out Telegram Channel for execlusive Stock market expertise</p>
            ...
            <div className="row mb-auto mx-auto mt-4 mt-xl-0 ">
              <p className={style.cert + " px-5 py-2 h2 rounded-2 mx-auto col-auto d-flex justify-content-center align-items-center"}><WorkspacePremiumIcon className="p-0  h3 m-0" />NISM Certiifed</p>
            </div>
          </div>
          ...
          <div className="row col-12 mx-auto d-flex justify-content-around p-5">
            {
              data.map((value, index) => {
                return <div className={style.card + " col-sm-5 col-md-4 col-xl-3 col-xxl-2 card p-0 mx-1 my-2"} >
